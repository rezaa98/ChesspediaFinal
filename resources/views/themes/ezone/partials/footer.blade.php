            ...
            <div class="widget-wrapper">
                <div class="footer-widget mb-30">
                    ...
                    <div class="footer-about-2">
                        <p>Chesspedia is a chess brand from Malang, Indonesia</p>
                    </div>
                </div>
                <div class="footer-widget mb-30">
                    ...
                    <div class="footer-info-wrapper-3">
                        <div class="footer-address-furniture">
                            ...
                            <div class="footer-info-content3">
                                <p>Brawijaya University, Malang, id</p>
                            </div>
                        </div>
                        <div class="footer-address-furniture">
                            <div class="footer-info-icon3">
                        ...
                        <div class="footer-address-furniture">
                            ...
                            <div class="footer-info-content3">
                                <p><a href="#"> admin@chesspedia.id</a> <br><a href="#"> admin@chesspedia.id</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="copyright-furniture">
                        <p>Copyright © <a href="https://chesspedia.my.id/">Chesspedia</a> 2020 . All Right Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
